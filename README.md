...
| :------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**AgentBeats Evaluation Pipeline**](https://github.com/ab-shetty/agentbeats-corebench) | First automated evaluation pipeline for CORE-Bench. Designed partial progress metrics in addition to binary pass/fail, improving agent interpretability and accuracy from *51%* to *70%* on reproducing scientific paper results. [Leaderboard](https://agentbeats.dev/ab-shetty/corebench-green)|
